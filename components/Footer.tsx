      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="font-inter text-ivory/25 text-[12px] leading-relaxed mb-5">
              Arte y ciencia al servicio<br />de tu belleza natural.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-8 h-8 border border-ivory/10 flex items-center justify-center text-ivory/30 hover:border-gold/40 hover:text-gold transition-all duration-300"
                >
                  {s.icon}
                </a>
              ))}
          ...
          {/* Navigation */}
          <div>
            <p className="font-inter text-ivory/20 text-[9px] tracking-[0.28em] uppercase mb-5">
              Navegación
            </p>
              ...
              {navLinks.map((item) => (
                <li key={item}>
                  <a
                    ...
                    className="font-inter text-ivory/40 text-[13px] hover:text-gold transition-colors duration-300"
                  >
                    {item}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="font-inter text-ivory/20 text-[12px] leading-relaxed pt-1">
                Babilla Plaza · Local 301<br />
                Cali, Colombia
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="font-inter text-ivory/18 text-[11px] pt-2 tracking-wide">Cali, Colombia</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-ivory/6 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-inter text-ivory/15 text-[11px]">
            © {year} Dra. Zharick Tobar · Todos los derechos reservados.
          </p>
          <div className="flex items-center gap-2">
            <span className="h-px w-5 bg-gold/25" />
            <span className="font-inter text-gold/30 text-[9px] tracking-[0.25em] uppercase">
              Medicina Estética Avanzada · Cali
            </span>
            <span className="h-px w-5 bg-gold/25" />
          </div>
        </div>
